...
| Grammar, WP-G | in progress | JSON-NUM-2 (`parse_num`, `print_num`), JSON-TEXT-4 (`bare_word`) and JSON-TEXT-5 (`bom_none`) proved. Left: JSON-TEXT-1, 2 and 3, JSON-STR-2 to 4 |
